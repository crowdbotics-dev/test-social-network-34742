...
## Project Structure
    ...
    ├── test_social_network_34742  # Django project configurations
...
1. Clone this repo and `cd test_social_network_34742`
...
2. Clone this repo and `cd test_social_network_34742`
